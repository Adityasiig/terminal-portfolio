            ...
            <div className="about-grid">
              <div className="about-text">
                ...
                <div className="about-details">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="detail-sep">:</span>
                    <span className="detail-val">&quot;Web Development & Security&quot;</span>
                  </div>
                  <div className="detail-item">
              ...
              <div className="about-visual">
                <div className="code-block">
                  ...
                  <div className="code-line">  <span className="code-key">title</span>: <span className="code-str">&quot;Full-Stack Dev&quot;</span>,</div>
                  <div className="code-line">  <span className="code-key">skills</span>: [</div>
                  <div className="code-line">    <span className="code-str">&quot;React&quot;</span>, <span className="code-str">&quot;Node.js&quot;</span>,</div>
                  <div className="code-line">    <span className="code-str">&quot;Python&quot;</span>, <span className="code-str">&quot;Security&quot;</span></div>
